...
def get_assessment_designer() -> Agent:
    ...
    return Agent(
        ...
        goal="Design comprehensive assessments, quizzes, practice exercises, and evaluation tools for {topic} that measure mastery according to {assessment_goal}. Create detailed quizzes with questions, answers, explanations, and clear rubrics for each module.",
